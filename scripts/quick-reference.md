...
| **Git** | [git/quick-reference.md](git/quick-reference.md) | status.ps1, pull.ps1, commit-and-push.ps1 (refuses to commit customer domain language — see `test/customer-domain-isolation-gate.ps1`) |
