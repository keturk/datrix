...
| **Development** | [dev/quick-reference.md](dev/quick-reference.md) | generate.ps1, syntax-checker.ps1, compile.ps1, libcst.ps1, semgrep.ps1, audit.ps1, cleanup_temps.ps1, ... |
