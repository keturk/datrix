...
EXCLUDED_ERROR_SITES: list[tuple[str, str]] = [
    ...
    ("datrix_codegen_common/transpiler/shared_transpiler.py", "__new__"),
    ...
    ("datrix_codegen_common/transpiler/python_visitor_expressions.py", "_transpile_dispatched_call"),
    ("datrix_codegen_common/transpiler/python_visitor_expressions.py", "_transpile_emitted_call"),
    ("datrix_codegen_common/transpiler/python_visitor_expressions.py", "_transpile_throws_call"),
    ("datrix_codegen_common/transpiler/typescript_visitor_expressions.py", "_transpile_dispatched_spec_call"),
    ("datrix_codegen_common/transpiler/typescript_visitor_expressions.py", "_transpile_emitted_spec_call"),
    ("datrix_codegen_common/transpiler/typescript_visitor_expressions.py", "_transpile_throws_spec_call"),
    ("datrix_codegen_common/transpiler/typescript_visitor_expressions.py", "_transpile_format_date_call"),
    ("datrix_codegen_common/transpiler/typescript_visitor_statements.py", "_handle_cache_call"),
    ...
    ("datrix_codegen_common/transpiler/typescript_transpiler_core.py", "emit_resolved_identifier"),
