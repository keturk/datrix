# PowerShell wrapper for status_deploy_tests.py
# This script runs the Python deployment test status checker
...
$PythonScript = Join-Path $libraryDir "test\status_deploy_tests.py"
...
try {
 ...
 Write-Host "Running deployment test status checker..." -ForegroundColor Cyan
 Write-Host ""
