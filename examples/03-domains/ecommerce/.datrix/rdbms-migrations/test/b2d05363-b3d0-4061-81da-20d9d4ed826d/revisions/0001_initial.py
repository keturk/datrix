...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_shipments_carrier_status", "shipments", ["carrier", "status"], unique=False
    )
    op.create_index(
        "ix_shipment_events_shipment_id_timestamp",
        "shipment_events",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_shipment_events_shipment_id_timestamp", table_name="shipment_events"
    )
