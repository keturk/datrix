...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_payments_customer_id_status",
        "payments",
        ["customer_id", "status"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_payments_transaction_id", "payments", ["transaction_id"], unique=False
    )
    op.create_index(
        "ix_payments_customer_id", "payments", ["customer_id"], unique=False
    )
