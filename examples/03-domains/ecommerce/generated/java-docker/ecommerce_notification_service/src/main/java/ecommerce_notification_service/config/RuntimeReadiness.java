package ecommerce_notification_service.config;
 ...
 * application uses ({@code RemoteConfig} from {@code ecommerce_notification_service}) once that
 * client is wired. Reports status by logical handle/key and rendered platform name. NEVER captures,
 * logs, or returns a resolved value.
 */
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"notification_db_password", "notification_db_password"},
          new String[] {"smtp_host", "smtp_host"},
          new String[] {"smtp_port", "smtp_port"},
          new String[] {"smtp_username", "smtp_username"},
          new String[] {"smtp_password", "smtp_password"});

  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          new String[] {"ecommerce_order_service_base_url", "ecommerce_order_service_base_url"},
          new String[] {"notification_db_database", "notification_db_database"},
          new String[] {"notification_db_host", "notification_db_host"},
          new String[] {"notification_db_port", "notification_db_port"},
          new String[] {"notification_db_user", "notification_db_user"},
          new String[] {"queues_host", "queues_host"},
          new String[] {"queues_port", "queues_port"});
