...
rdbms_id 64704790-5f82-4b4e-8d2b-0dbc989dfd3f.
...
ENGINE = "postgres"
RDBMS_ID = "64704790-5f82-4b4e-8d2b-0dbc989dfd3f"
SERVICE_NAME = "ecommerce.NotificationService"
SERVICE_VERSION = "1.0.0"
CONTAINER_NAME = "ecommerce.NotificationService"
CONTAINER_KIND = "service"
BLOCK_NAME = "notificationDb"
LATEST_REVISION = None
# PostgreSQL schema the block's tables and enums live in; None for the engine
# default. The reflector reads from AND stamps this so live and recorded snapshots
# agree on placement (a version-1 reflector left it unset, which made drift report
# a spurious relocation to the default schema on every comparison).
SCHEMA_NAME = None
