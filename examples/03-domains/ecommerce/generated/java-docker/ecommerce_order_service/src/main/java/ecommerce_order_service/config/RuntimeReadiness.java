 ...
 * application uses ({@code RemoteConfig} from {@code ecommerce_order_service}) once that client is
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"order_db_password", "order_db_password"},
          new String[] {"trusted_caller_secret", "trusted_caller_secret"});

  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          new String[] {"ecommerce_product_service_base_url", "ecommerce_product_service_base_url"},
          new String[] {"ecommerce_user_service_base_url", "ecommerce_user_service_base_url"},
          new String[] {"mq_brokers", "mq_brokers"},
          new String[] {"mq_port", "mq_port"},
          new String[] {"order_db_database", "order_db_database"},
          new String[] {"order_db_host", "order_db_host"},
          new String[] {"order_db_port", "order_db_port"},
          new String[] {"order_db_user", "order_db_user"},
