 ...
 * application uses ({@code RemoteConfig} from {@code ecommerce_payment_service}) once that client
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"stripe_secret_key", "stripe_secret_key"},
          new String[] {"payment_webhook_secret", "payment_webhook_secret"},
          new String[] {"payment_db_password", "payment_db_password"});
  ...
  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          ...
          new String[] {"payment_db_database", "payment_db_database"},
          new String[] {"payment_db_host", "payment_db_host"},
          new String[] {"payment_db_port", "payment_db_port"},
          new String[] {"payment_db_user", "payment_db_user"},
