package ecommerce_user_service.config;
 ...
 * application uses ({@code RemoteConfig} from {@code ecommerce_user_service}) once that client is
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"user_db_password", "user_db_password"},
  ...
  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          ...
          new String[] {"user_db_database", "user_db_database"},
          new String[] {"user_db_host", "user_db_host"},
          new String[] {"user_db_port", "user_db_port"},
          new String[] {"user_db_user", "user_db_user"});
