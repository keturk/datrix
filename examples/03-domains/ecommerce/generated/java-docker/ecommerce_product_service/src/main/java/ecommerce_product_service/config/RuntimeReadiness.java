package ecommerce_product_service.config;
 ...
 * application uses ({@code RemoteConfig} from {@code ecommerce_product_service}) once that client
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"product_db_password", "product_db_password"},
          new String[] {"docdb_secret-key", "docdb_secret-key"},
          new String[] {"minio_access_key", "minio_access_key"},
          new String[] {"minio_secret_key", "minio_secret_key"},
  ...
  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          ...
          new String[] {"product_db_database", "product_db_database"},
          new String[] {"product_db_host", "product_db_host"},
          new String[] {"product_db_port", "product_db_port"},
          new String[] {"product_db_user", "product_db_user"},
          new String[] {"redis_database", "redis_database"},
          new String[] {"redis_host", "redis_host"},
          new String[] {"redis_port", "redis_port"},
          new String[] {"store_endpoint", "store_endpoint"});
