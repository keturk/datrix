package ecommerce_shipping_service.config;
 ...
 * application uses ({@code RemoteConfig} from {@code ecommerce_shipping_service}) once that client
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"carrier_webhook_secret", "carrier_webhook_secret"},
          new String[] {"shipping_db_password", "shipping_db_password"},
  ...
  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          ...
          new String[] {"shipping_db_database", "shipping_db_database"},
          new String[] {"shipping_db_host", "shipping_db_host"},
          new String[] {"shipping_db_port", "shipping_db_port"},
          new String[] {"shipping_db_user", "shipping_db_user"});
