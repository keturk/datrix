 ...
 * SecretsService from '../ecommerce_product_service/secrets/secrets.service'), proving the live
...
import { SecretResolutionError, SecretsService } from '../ecommerce_product_service/secrets/secrets.service';
...
const REQUIRED_CONFIG_KEYS: Array<[string, string]> = [
  ...
  ["mq_port", "mq_port"],
  ["product_db_database", "product_db_database"],
