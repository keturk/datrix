...
import { requestContextMiddleware } from './ecommerce_notification_service/_requestContext';
...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('ecommerce.NotificationService API')
    .setDescription('Auto-generated API documentation for ecommerce.NotificationService')
    .setVersion('1.0')
    .addBearerAuth()
    .build();
