...
async function bootstrap() {
  ...
  const document = SwaggerModule.createDocument(app, config, {
    extraModels: [ChangePasswordRequest, ForgotPasswordRequest, LoginRequest, LoginResponse, LogoutRequest, RegisterRequest, ResetPasswordRequest, SessionValidationResponse, UpdateProfileRequest, UpdateUserStatusRequest, ValidateSessionRequest, VerifyEmailRequest],
  });
