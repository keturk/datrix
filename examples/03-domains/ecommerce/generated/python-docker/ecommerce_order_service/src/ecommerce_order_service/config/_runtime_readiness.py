...
``ecommerce_order_service.config.remote_config`` and the
``ecommerce_order_service.config._secrets_resolver`` module), proving the live
...
from ecommerce_order_service.config import _secrets_resolver
