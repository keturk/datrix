...
async def test_user_api_post_register_public_no_auth(client):
...
async def test_user_api_post_login_public_no_auth(client):
...
async def test_user_api_post_verify_email_public_no_auth(client):
...
async def test_user_api_post_forgot_password_public_no_auth(client):
...
async def test_user_api_post_reset_password_public_no_auth(client):
...
async def test_user_api_list_users_unauthenticated(unauth_client):
...
async def test_user_api_get_user_unauthenticated(unauth_client):
...
async def test_user_api_create_user_unauthenticated(unauth_client):
...
async def test_user_api_update_user_unauthenticated(unauth_client):
...
async def test_user_api_delete_user_unauthenticated(unauth_client):
...
async def test_user_api_post_logout_unauthenticated(unauth_client):
...
async def test_user_api_get_me_unauthenticated(unauth_client):
...
async def test_user_api_put_me_unauthenticated(unauth_client):
...
async def test_user_api_put_me_password_unauthenticated(unauth_client):
...
async def test_user_api_put_by_id_status_unauthenticated(unauth_client):
...
async def test_user_api_get_service_by_id_unauthenticated(unauth_client):
...
async def test_user_api_post_service_validate_session_unauthenticated(unauth_client):
...
async def test_user_api_list_users_wrong_role(wrong_role_client):
...
async def test_user_api_get_user_wrong_role(wrong_role_client):
...
async def test_user_api_create_user_wrong_role(wrong_role_client):
...
async def test_user_api_update_user_wrong_role(wrong_role_client):
...
async def test_user_api_delete_user_wrong_role(wrong_role_client):
...
async def test_user_api_put_by_id_status_wrong_role(wrong_role_client):
...
async def test_user_api_get_service_by_id_non_service_token(wrong_role_client):
