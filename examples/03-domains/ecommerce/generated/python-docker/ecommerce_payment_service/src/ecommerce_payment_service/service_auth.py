"""Service-to-service authentication for ecommerce.PaymentService.
...
from ecommerce_payment_service.config._secrets_resolver import get_secret
from ecommerce_payment_service.config.settings import get_settings
