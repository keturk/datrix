...
``ecommerce_payment_service.config.remote_config`` and the
``ecommerce_payment_service.config._secrets_resolver`` module), proving the live
...
from ecommerce_payment_service.config import _secrets_resolver
