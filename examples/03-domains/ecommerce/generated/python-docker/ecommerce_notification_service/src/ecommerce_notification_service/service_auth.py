"""Service-to-service authentication for ecommerce.NotificationService.
...
from ecommerce_notification_service.config._secrets_resolver import get_secret
from ecommerce_notification_service.config.settings import get_settings
