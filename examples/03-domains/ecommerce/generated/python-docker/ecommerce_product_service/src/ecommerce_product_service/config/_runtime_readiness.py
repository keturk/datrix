...
``ecommerce_product_service.config.remote_config`` and the
``ecommerce_product_service.config._secrets_resolver`` module), proving the live
...
from ecommerce_product_service.config import _secrets_resolver
