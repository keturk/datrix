...
``ecommerce_shipping_service.config.remote_config`` and the
``ecommerce_shipping_service.config._secrets_resolver`` module), proving the live
...
from ecommerce_shipping_service.config import _secrets_resolver
