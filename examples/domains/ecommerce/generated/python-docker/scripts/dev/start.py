...
Starts all Docker services for development.
Auto-generated by datrix-codegen-python. Do not edit manually.

Usage:
    python scripts/dev/start.py                 # Start all services
    python scripts/dev/start.py --build         # Rebuild and start
    python scripts/dev/start.py --logs          # Start with log streaming
"""
...
def main() -> int:
    ...
    parser.add_argument(
        "--logs", action="store_true", help="Stream logs after starting"
    )
    ...
    if args.build:
        cmd.insert(-1, "--build")
    print("Starting ecommerce services...")
