 ...
 * application uses ({@code RemoteConfig} from {@code library_member_service}) once that client is
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(new String[] {"member_db_password", "member_db_password"});

  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          new String[] {"member_db_database", "member_db_database"},
          new String[] {"member_db_host", "member_db_host"},
          new String[] {"member_db_port", "member_db_port"},
          new String[] {"member_db_user", "member_db_user"});
