 ...
 * SecretsService from '../examples_ingestion_service/secrets/secrets.service'), proving the live
...
const REQUIRED_CONFIG_KEYS: Array<[string, string]> = [
  ["examples_ingestion_service_base_url", "examples_ingestion_service_base_url"],
];
