 ...
 * application uses ({@code RemoteConfig} from {@code library_notification_service}) once that
...
public final class RuntimeReadiness {
  ...
  public static final List<String[]> REQUIRED_SECRET_HANDLES =
      List.<String[]>of(
          new String[] {"notif_db_password", "notif_db_password"},
  ...
  public static final List<String[]> REQUIRED_CONFIG_KEYS =
      List.<String[]>of(
          ...
          new String[] {"notif_db_database", "notif_db_database"},
          new String[] {"notif_db_host", "notif_db_host"},
          new String[] {"notif_db_port", "notif_db_port"},
          new String[] {"notif_db_user", "notif_db_user"});
